...
// testAllDiagramTypes demonstrates all diagram types
func testAllDiagramTypes() {
...
func createMockPCAPModel() *types.NetworkModel {
	...
	assets := []*types.Asset{
		{
			...
			PurdueLevel:  types.L1,
			IEC62443Zone: types.IndustrialZone,
			Criticality:  types.CriticalAsset,
			Exposure:     types.OTOnly,
			Protocols:    []types.Protocol{"EtherNet/IP", "Modbus TCP"},
		},
		{
			ID:           "192.168.1.20",
			IP:           "192.168.1.20",
			...
			IEC62443Zone: types.IndustrialZone,
			Criticality:  types.HighAsset,
			Exposure:     types.OTOnly,
			Protocols:    []types.Protocol{"S7Comm", "OPC-UA"},
		},
		{
			ID:           "192.168.10.5",
			IP:           "192.168.10.5",
			...
			PurdueLevel:  types.L3,
			IEC62443Zone: types.EnterpriseZone,
			Criticality:  types.HighAsset,
			Exposure:     types.CorporateExposed,
			Protocols:    []types.Protocol{"OPC-UA", "DNP3"},
		},
	}
	...
	model.Networks["production_lan"] = &types.NetworkSegment{
		ID:      "production_lan",
		CIDR:    "192.168.1.0/24",
		Name:    "Production LAN",
		...
		Assets:  []*types.Asset{assets[0], assets[1]},
	}

	model.Networks["scada_dmz"] = &types.NetworkSegment{
		ID:      "scada_dmz",
		CIDR:    "192.168.10.0/24",
		Name:    "SCADA DMZ",
		Zone:    types.EnterpriseZone,
		Risk:    types.MediumRisk,
		Purpose: "SCADA/HMI",
		Assets:  []*types.Asset{assets[2]},
	}

	// Add mock flows
	model.Flows[types.FlowKey{SrcIP: "192.168.1.20", DstIP: "192.168.1.10", Proto: "EtherNet/IP"}] = &types.Flow{
		Source:      "192.168.1.20",
